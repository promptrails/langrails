...
const defaultBaseURL = "https://llm.chutes.ai/v1/chat/completions"

// Provider implements langrails.Provider for Chutes AI's API.
...
func New(apiKey string, opts ...Option) *Provider {
	cfg := compat.Config{Name: "chutes", BaseURL: defaultBaseURL, APIKey: apiKey}
