...
const defaultBaseURL = "https://api.hyperbolic.xyz/v1/chat/completions"

// Provider implements langrails.Provider for Hyperbolic's API.
...
// New creates a new Hyperbolic provider.
func New(apiKey string, opts ...Option) *Provider {
	cfg := compat.Config{Name: "hyperbolic", BaseURL: defaultBaseURL, APIKey: apiKey}
