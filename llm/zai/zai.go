...
const defaultBaseURL = "https://api.z.ai/api/paas/v4/chat/completions"

// Provider implements langrails.Provider for Z.AI's API.
...
func New(apiKey string, opts ...Option) *Provider {
	cfg := compat.Config{Name: "zai", BaseURL: defaultBaseURL, APIKey: apiKey}
