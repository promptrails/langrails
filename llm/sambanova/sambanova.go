...
const defaultBaseURL = "https://api.sambanova.ai/v1/chat/completions"

// Provider implements langrails.Provider for SambaNova Cloud's API.
...
func New(apiKey string, opts ...Option) *Provider {
	cfg := compat.Config{Name: "sambanova", BaseURL: defaultBaseURL, APIKey: apiKey}
