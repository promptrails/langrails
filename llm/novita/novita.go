...
const defaultBaseURL = "https://api.novita.ai/openai/chat/completions"

// Provider implements langrails.Provider for Novita AI's API.
...
func New(apiKey string, opts ...Option) *Provider {
	cfg := compat.Config{Name: "novita", BaseURL: defaultBaseURL, APIKey: apiKey}
