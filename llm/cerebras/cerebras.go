...
const defaultBaseURL = "https://api.cerebras.ai/v1/chat/completions"

// Provider implements langrails.Provider for Cerebras Inference's API.
...
func New(apiKey string, opts ...Option) *Provider {
	cfg := compat.Config{Name: "cerebras", BaseURL: defaultBaseURL, APIKey: apiKey}
