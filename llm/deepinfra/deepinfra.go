...
const defaultBaseURL = "https://api.deepinfra.com/v1/openai/chat/completions"

// Provider implements langrails.Provider for DeepInfra's API.
...
func New(apiKey string, opts ...Option) *Provider {
	cfg := compat.Config{Name: "deepinfra", BaseURL: defaultBaseURL, APIKey: apiKey}
